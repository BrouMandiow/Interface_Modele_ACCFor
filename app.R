...
tryCatch({
  if (!file.exists(model_path)) {
    cat("Téléchargement du modèle depuis Google Drive...\n")
    download.file(model_url, destfile = model_path, mode = "wb")
  }
  model <- readRDS(model_path)
  cat("Modèle chargé avec succès.\n")
}, error = function(e) {
  stop("Erreur lors du chargement du modèle : ", e$message)
})
...
ui <- fluidPage(
  ...
  tags$head(
    tags$script(HTML("
      Shiny.addCustomMessageHandler('modelStatus', function(message) {
        alert(message);
      });
    "))
  ),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("type_eco", "Type écologique :", c("FE10", "FE11", "FE12", "FE13", "FE14", "FE15", "FE16", "FE20", "FE21", "FE22", "FE23", "FE24", "FE25", "FE26", "FE30", "FE31", "FE32", "FE32H", "FE35", "FE42", "FE50", "FE51", "FE52", "FE60", "FE61", "FE62", "FO14", "FO15", "FO16", "FO18", "FC10", "FC12", "MA18R", "MF14", "MF15", "MF16", "MF18", "MJ10", "MJ11", "MJ12", "MJ13", "MJ14", "MJ15", "MJ16", "MJ18", "MJ20", "MJ21", "MJ22", "MJ23", "MJ24", "MJ25", "MJ26", "MS11", "MS12", "MS14", "MS15", "MS18", "MS20", "MS21", "MS22", "MS23", "MS24", "MS25", "MS26", "MS40", "MS42", "MS60", "MS61", "MS62", "MS63", "MS64", "MS65", "MS66", "RB10", "RB11", "RB12", "RB13", "RB14", "RB15", "RB16", "RC38", "RE20", "RE21", "RE22", "RE24", "RE25", "RE37", "RE38", "RE39", "RP10", "RP11", "RP12", "RP13", "RP14", "RP15", "RS10", "RS11", "RS12", "RS13", "RS14", "RS15", "RS16", "RS18", "RS20", "RS21", "RS22", "RS22M", "RS23", "RS24", "RS25", "RS25S", "RS26", "RS37", "RS38", "RS39", "RS50", "RS51", "RS52", "RS54", "RS55", "TOB9D", "TOB9U", "TOF8U", "unknown")),
      selectInput("co_ter", "Cote terrain :", c("A", "AF", "AL", "ANT", "DH", "DS", "EAU", "GR", "ILE", "INO", "LTE", "NF", "NX", "RO", "TNP", "unknown")),
      selectInput("cl_pent", "Classe de pente :", c("A", "B", "C", "D", "E", "F", "S", "unknown")),
      selectInput("dep_sur", "Dépôt de surface :", c("1A", "1AA", "1AB", "1AD", "1AM", "1AY", "1BF", "1BI", "1BP", "1BC", "1BG", "1BD", "2A", "2AE", "2AK", "2AT", "2BD", "2BE", "3AC", "3AE", "3AN", "3D", "4A", "4GA", "4GD", "4GS", "5A", "5AM", "5AY", "5L", "5S", "5SY", "6A", "6S", "6SY", "7E", "7T", "7TM", "7TY", "8A", "8AY", "8AM", "8C", "8CM", "8CY", "8E", "8F", "8G", "9S", "9SY", "M1A", "M8A", "R", "R1A", "R4G", "R5A", "R5S", "R7T", "R8A", "R8C", "unknown")),
      selectInput("cl_drai", "Classe de drainage :", c("0", "10", "11", "16", "20", "21", "30", "31", "33", "40", "41", "43", "44", "50", "51", "53", "60", "61", "63", "unknown")),
      ...
      selectInput("cl_age", "Classe d'âge :", c("10", "10JIN", "1050", "1070", "120", "12010", "12030", "12050", "12070", "12090", "120JI", "120VI", "120.0", "30", "30.0", "30VIN", "3010", "30120", "3030", "3050", "3070", "3090", "5010", "50120", "5030", "5050", "5070", "5090", "50", "70", "70.0", "7010", "70120", "7030", "7050", "7070", "7090", "90", "90.0", "9010", "90120", "9050", "9070", "9090", "JIN", "JIN10", "JIN12", "JIN30", "JIN70", "JIR", "VIN", "VIN10", "VIN12", "VIN30", "VIN50", "VINJI", "VIR", "unknown")),
